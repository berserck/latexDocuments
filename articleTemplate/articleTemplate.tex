...
% easy way to define units in math mode
...
\newcommand{\docurl}{https://github.com/berserck/latexDocuments/tree/master/articleTemplate} 
 %update the version
 \newcommand{\docver}{v1}
...
Both boxes accept a optional argument, to change the title of the boxes, like in the example:
\begin{lstlisting}[language={[LaTeX]TeX}]
\begin{infobox} [My String goes in info box]
 This is an Infor box with a personalized title.
\end{infobox}
\end{lstlisting}
That will look like:
\begin{infobox} [My String goes in info box]
